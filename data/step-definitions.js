(function attachStepDefinitions(root, factory) {
  ...
  const PLUS_SKIP_CHECKOUT_PREFIX_STEP_DEFINITIONS = PLUS_PAYPAL_PREFIX_STEP_DEFINITIONS.slice(0, 5);
  ...
  const PLUS_SKIP_CHECKOUT_STEP_DEFINITIONS = createHostedCheckoutSteps(PLUS_SKIP_CHECKOUT_PREFIX_STEP_DEFINITIONS, 7, 70, SIGNUP_METHOD_EMAIL);
  const PLUS_SKIP_CHECKOUT_SUB2API_SESSION_STEP_DEFINITIONS = createHostedCheckoutSteps(
    PLUS_SKIP_CHECKOUT_PREFIX_STEP_DEFINITIONS,
    7,
    70,
    SIGNUP_METHOD_EMAIL,
    { plusAccountAccessStrategy: PLUS_ACCOUNT_ACCESS_STRATEGY_SUB2API_CODEX_SESSION }
  );
  const PLUS_SKIP_CHECKOUT_CPA_SESSION_STEP_DEFINITIONS = createHostedCheckoutSteps(
    PLUS_SKIP_CHECKOUT_PREFIX_STEP_DEFINITIONS,
    7,
    70,
    SIGNUP_METHOD_EMAIL,
  ...
  const PLUS_SKIP_CHECKOUT_PHONE_STEP_DEFINITIONS = createHostedCheckoutSteps(PLUS_SKIP_CHECKOUT_PREFIX_STEP_DEFINITIONS, 7, 70, SIGNUP_METHOD_PHONE);
  const PLUS_SKIP_CHECKOUT_PHONE_BOUND_EMAIL_RELOGIN_STEP_DEFINITIONS = createHostedCheckoutSteps(PLUS_SKIP_CHECKOUT_PREFIX_STEP_DEFINITIONS, 7, 70, SIGNUP_METHOD_PHONE, { phoneSignupReloginAfterBindEmailEnabled: true });
  ...
  function getOpenAiModeStepDefinitions(options = {}) {
    ...
    if (paymentMethod === PLUS_PAYMENT_METHOD_SKIP_CHECKOUT) {
      ...
      return PLUS_SKIP_CHECKOUT_STEP_DEFINITIONS;
    }
  ...
  return {
    ...
    PLUS_PAYMENT_METHOD_SKIP_CHECKOUT,
    PLUS_PAYPAL_STEP_DEFINITIONS,
    PLUS_PAYPAL_SUB2API_SESSION_STEP_DEFINITIONS,
    PLUS_PAYPAL_CPA_SESSION_STEP_DEFINITIONS,
    PLUS_PAYPAL_PHONE_STEP_DEFINITIONS,
